...
const handleGoogleLogin = () => {
  alert('Đang kết nối tài khoản Google để đăng ký...')
}
</script>
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 overflow-y-auto">
      ...
      >
        ...
        <button
          ...
          class="w-full py-2.5 border border-gray-200 dark:border-zinc-800 rounded-xl bg-white dark:bg-zinc-955 text-zinc-700 dark:text-zinc-300 text-xs font-bold flex items-center justify-center gap-2 hover:bg-gray-50 dark:hover:bg-zinc-900 transition-colors shadow-xs cursor-pointer"
        >
          <!-- SVG Google Icon -->
