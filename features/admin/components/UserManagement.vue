            ...
            >
              <td class="px-6 py-4">
                <div class="flex items-center gap-3">
                  <div class="w-8 h-8 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-zinc-550 border border-gray-200 dark:border-zinc-700">
                    <User class="w-4.5 h-4.5" />
                  </div>
                  <div class="space-y-0.5">
                    <h4 class="text-xs font-bold text-zinc-900 dark:text-white">{{ user.username }}</h4>
              ...
              <td class="px-6 py-4 text-xs font-semibold text-zinc-550 flex items-center gap-1 pt-6">
