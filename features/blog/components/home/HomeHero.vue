...
<template>
  <section class="mb-8">
    <div class="grid grid-cols-1 lg:grid-cols-10 gap-6">
      <!-- Big Featured Post -->
      <div class="lg:col-span-7 relative group overflow-hidden rounded-xl bg-zinc-950 text-white aspect-[16/9] shadow-md">
        <img
        ...
        <div class="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent flex flex-col justify-end p-6 md:p-8">
          <span class="self-start bg-[#3498db] text-white text-[11px] font-extrabold uppercase px-2 py-0.5 rounded mb-3">
      ...
      <div class="lg:col-span-3 flex flex-col gap-4">
        ...
        >
          ...
          <div class="absolute inset-0 bg-gradient-to-t from-black/90 to-transparent flex flex-col justify-end p-4">
            <span class="self-start bg-[#f39c12] text-white text-[9px] font-bold uppercase px-1.5 py-0.5 rounded mb-2">
              {{ fPost.category }}
            </span>
