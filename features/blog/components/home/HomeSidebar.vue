...
import { Facebook, Twitter, Instagram, Youtube, TrendingUp, Eye, Bookmark, ChevronRight } from 'lucide-vue-next'
...
<template>
  <aside class="lg:col-span-3 space-y-8">
    ...
    <div class="bg-white dark:bg-zinc-900 p-5 rounded-xl border border-border shadow-sm">
      <h3 class="text-sm font-bold uppercase tracking-wider border-b-2 border-[#3498db] pb-2 mb-4 text-zinc-900 dark:text-white">
        Theo dõi chúng tôi
      </h3>
      <div class="grid grid-cols-2 gap-3 text-xs font-semibold">
        <a href="#" class="flex items-center gap-2 p-2 bg-blue-50 dark:bg-blue-900/10 text-blue-600 dark:text-blue-400 rounded hover:opacity-90">
          <Facebook class="w-4 h-4" /> Facebook
        </a>
        <a href="#" class="flex items-center gap-2 p-2 bg-sky-50 dark:bg-sky-900/10 text-sky-500 dark:text-sky-400 rounded hover:opacity-90">
          <Twitter class="w-4 h-4" /> Twitter
        </a>
        <a href="#" class="flex items-center gap-2 p-2 bg-pink-50 dark:bg-pink-900/10 text-pink-600 dark:text-pink-400 rounded hover:opacity-90">
          <Instagram class="w-4 h-4" /> Instagram
        </a>
        <a href="#" class="flex items-center gap-2 p-2 bg-red-50 dark:bg-red-900/10 text-red-650 dark:text-red-400 rounded hover:opacity-90">
    ...
    <div class="bg-white dark:bg-zinc-900 p-3 rounded-xl border border-border shadow-sm flex flex-col items-center justify-center">
    ...
    <div class="bg-white dark:bg-zinc-900 p-5 rounded-xl border border-border shadow-sm">
      ...
      <ul class="space-y-2 text-xs">
        <li v-for="cat in ['Công nghệ', 'Điện thoại', 'Tai nghe & Loa', 'Phần mềm & Ứng dụng', 'AI & Xe điện']" :key="cat">
          <a href="#" class="flex justify-between items-center py-2 px-3 hover:bg-gray-50 dark:hover:bg-zinc-800/50 rounded text-zinc-700 dark:text-zinc-300">
