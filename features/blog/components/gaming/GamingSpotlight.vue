  ...
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div
        ...
        :key="post.id"
        class="flex flex-col bg-white dark:bg-[#13161c] rounded-xl border border-gray-250 dark:border-zinc-850 overflow-hidden group shadow-xs hover:shadow-md transition-all duration-300"
      >
        ...
        <div class="p-5 flex-grow flex flex-col justify-between">
          <div>
            ...
            >
              <NuxtLink :to="localePath('/blog/' + post.slug + '.' + post.id)">{{ post.title }}</NuxtLink>
            </h4>
          ...
          <div
            class="flex items-center gap-4 text-[10px] text-zinc-555 border-t border-gray-150 dark:border-zinc-850 pt-3"
          >
            <span>{{ $t('gaming.by_author', { author: post.author }) }}</span>
