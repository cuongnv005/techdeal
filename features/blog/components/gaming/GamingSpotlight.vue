        ...
        <div class="p-5 flex-grow flex flex-col justify-between">
          <div>
            ...
            <h4 class="text-base font-bold leading-snug text-zinc-900 dark:text-white hover:text-[#e74c3c] transition-colors mb-3">
              <NuxtLink :to="`/blog/${spotlightBigPost.slug}`">{{ spotlightBigPost.title }}</NuxtLink>
            </h4>
      ...
      <div class="md:col-span-4 space-y-4">
        ...
        >
          ...
          <div class="flex flex-col justify-between flex-grow">
            ...
            <span class="text-[9px] font-semibold text-zinc-500 uppercase mt-2">{{ sPost.category }}</span>
          </div>
        </div>
      </div>
    </div>
